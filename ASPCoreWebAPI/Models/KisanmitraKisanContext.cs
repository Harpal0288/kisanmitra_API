...
public partial class KisanmitraKisanContext : DbContext
{
    ...
    public virtual DbSet<VwGetFarmerHavingEquipment> VwGetFarmerHavingEquipments { get; set; }

    public virtual DbSet<VwGetFarmersWhoCultivateCrop> VwGetFarmersWhoCultivateCrops { get; set; }

    public virtual DbSet<VwGetUsersDataWithRoleOfAdmin> VwGetUsersDataWithRoleOfAdmins { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<VwGetFarmerHavingEquipment>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_GetFarmerHavingEquipment");

            entity.Property(e => e.AvailabiltyStatus).HasColumnName("Availabilty Status");
            entity.Property(e => e.EquipmentDescription)
                .HasMaxLength(1000)
                .HasColumnName("Equipment Description");
            entity.Property(e => e.EquipmentName)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("Equipment Name");
            entity.Property(e => e.EquipmentType)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("Equipment Type");
            entity.Property(e => e.FarmerName)
                .HasMaxLength(255)
                .HasColumnName("Farmer Name");
            entity.Property(e => e.RentPrice).HasColumnName("Rent Price");
        });

        modelBuilder.Entity<VwGetFarmersWhoCultivateCrop>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_GetFarmersWhoCultivateCrops");

            entity.Property(e => e.Crop).HasMaxLength(255);
            entity.Property(e => e.FarmLocation)
                .HasMaxLength(255)
                .HasColumnName("Farm Location");
            entity.Property(e => e.FarmSize)
                .HasMaxLength(250)
                .HasColumnName("Farm Size");
            entity.Property(e => e.FarmerExperience).HasColumnName("Farmer Experience");
            entity.Property(e => e.FarmerName)
                .HasMaxLength(255)
                .HasColumnName("Farmer Name");
            entity.Property(e => e.IrrigationMethod)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("Irrigation Method");
            entity.Property(e => e.LanguagePreference)
                .HasMaxLength(255)
                .HasColumnName("Language Preference");
            entity.Property(e => e.MembershipExpiry)
                .HasColumnType("datetime")
                .HasColumnName("Membership Expiry");
            entity.Property(e => e.MembershipStatus)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("Membership Status");
            entity.Property(e => e.Pincode).HasMaxLength(255);
            entity.Property(e => e.SoilType)
                .HasMaxLength(255)
                .IsUnicode(false)
                .HasColumnName("Soil Type");
        });

        modelBuilder.Entity<VwGetUsersDataWithRoleOfAdmin>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_GetUsersDataWithRoleOfAdmin");

            entity.Property(e => e.AadhaarNumber)
                .HasMaxLength(255)
                .HasColumnName("Aadhaar Number");
